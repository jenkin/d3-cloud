...
var data = words.map(function(d,i) {
  ...
  return {
    ...
    center: [c[0]*w/(n+1),c[1]*h/n],
    cluster: ""+c[0]+c[1]
  };
});

var s = d3.scale.sqrt().domain(d3.extent(data.map(function(d) { return d.value; }))).range([4,32]);
...
},{"../":2,"d3":4,"jquery":5}],2:[function(require,module,exports){
